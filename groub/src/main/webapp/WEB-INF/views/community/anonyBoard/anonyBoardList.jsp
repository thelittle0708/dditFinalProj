...
<div class="container">
	<div class="row">
		<div class="card mb-3">
			...
			<div id="tableExample3" data-list='{&quot;valueNames&quot;:[&quot;pstNo&quot;,&quot;pstTtl&quot;,&quot;mdfcnDt&quot;,&quot;inqCnt&quot;],&quot;page&quot;:10,&quot;pagination&quot;:true}'>
				<div class="row justify-content-end g-0">
					<div class="col-auto col-sm-7 mb-0 ">
						<a href="/community/anonyboard/register" class="btn btn-primary me-1 mb-1" type="button">글쓰기</a>
					</div>
						...
						<tbody class="list">
							...
							<c:forEach var="boardVO" items="${data}" varStatus="stat">
								<tr >
									...
									<td class="pstTtl mb-1 ps-4"><a href="/community/anonyboard/detail?pstNo=${boardVO.pstNo}" style="color:black"> ${boardVO.pstTtl}</a></td>
