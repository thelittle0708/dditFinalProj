...
<div class="container">
	<div class="row">
		...
		<form action="/community/board/update" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
	$(".clsDelete").on("click",function(){
		...
		$.ajax({
			url:"/community/board/updateFileExist",
	...
	$("#btnCancel").on("click",function(){
		// /community/board/detail?pstNo=${data.pstNo}
		...
		$.ajax({
			url:"/community/board/updateFileExistCancel",
			contentType:"application/json;charset=utf-8",
			data:JSON.stringify(data),
			type:"post",
			dataType:"text",
