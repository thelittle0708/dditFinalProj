...
<div class="card mb-3">
	...
	<div class="card-body d-flex justify-content-between">
		<div>
			...
			<c:if test="${msg.statCd!='MM003'||msg.statCd!='MM004'}">
		...
		<div class="row">
			<div class="col-md d-flex">
				<div class="avatar avatar-2xl">
					<img class="rounded-circle" src="${msg.userImg}"
						alt="">
				</div>
				<div class="flex-1 ms-2">
					<h5 class="mb-0">${msg.memoTtl}</h5>
					<a class="text-800 fs--1" href="/msg/compose?userId=${msg.userId}">
						<span class="fw-semi-bold">${msg.deptNm}과 ${msg.cstCdNm} ${msg.userNm}</span>
						<span class="ms-1 text-500">&lt; ${msg.userId}&gt;</span>
					</a>
				</div>
			</div>
			<div
				class="col-md-auto ms-auto d-flex align-items-center ps-6 ps-md-3">
				<small>${msg.dsptchDt}</small>
			</div>
		</div>
	</div>
...
<script>
	...
	$('#msg-answer').on('click',()=>{
		location.href="/msg/compose?userId=${msg.userId}"
	});
