									...
									<td class="align-middle">
										...
										<div class="d-flex">
											<input id="vacChose" class="form-control text-center"
												...
												id="vacTp" name="draftVacVO.vacTp" value="" required />
											<!-- 보유 휴가 종류 선택 -->
										</div>
									...
									<td class="col-sm-6">
										<div class="d-flex ">
											<input class="form-control datetimepicker vac"
												id="datepicker" name="draftVacVO.bgngDt" type="text"
					...
					<div>
						<div class="min-vh-5 d-none">
							<textarea id="draftClobContent" class="tinymce"
								data-tinymce="data-tinymce" name="drStrg">test</textarea>
				...
				<div class="modal-dialog mt-6" role="document">
					<div class="modal-content border-0">
						...
						<div class="modal-body p-0">
							...
							<div class="p-4">
								<div>
									<input type="hidden" id="vacGrntNo" name="draftVacVO.vacGrntNo"
										value="" />
									<table class="table">
										<thead>
											<tr>
																...
																<div class="card mb-3 shadow-sm dark__bg-1100">
																	<div class="card-body border p-2">
																		...
																		property="principal.userVO.userImg" />">
																			...
																			<div class="mx-auto">
																				<sec:authentication
																					property="principal.userVO.userNm" />
																			</div>
																			<div class="mx-auto">
																				<sec:authentication
																					property="principal.userVO.deptNm" />
																			</div>
																			<div class="mx-auto">
																				<sec:authentication
																					property="principal.userVO.jbgdNm" />
																			</div>
																			<div class="mx-auto">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#getApproval").on('click', function() {
			...
			//알람
			stomp.send('/pub/vacAlarm', {}, JSON.stringify({
		...
		$("#setOpnionBtn").on("click", function() {
			...
			var opinionTemp = `
					<div class="alert d-flex align-items-center p-0 mb-0">						
							...
							name="draftOpnVOList[` + count + `].opnnCn"
							readonly value="${draftUserVO.userNm}: ` + opinion +  `"/>
						<button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>	
				`
			opinionTemp += `<input type="hidden" name="draftOpnVOList[` + count + `].userId" value="${draftUserVO.userId}"/>`
			opinionTemp += `<input type="hidden" name="draftOpnVOList[` + count + `].drOpnnDt" value="`+ nowTime +`"/></div>`
				...
				`<div class="alert card mb-3 kanban-item shadow-sm dark__bg-1100 p-0 draft-div draft-line" style="border: 0px">
					<div class="card-body border p-2">
						<div class="d-flex align-items-center fs--1 fw-medium font-sans-serif mb-0">
							...
							<input type="hidden" class="lineId" id="lineId" value="` + userId + `" />
