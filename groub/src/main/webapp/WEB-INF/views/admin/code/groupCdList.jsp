			    ...
			    <table class="table table-bordered table-striped fs--1 mb-0">
			      <thead class="bg-200 text-900">
			        <tr>
			          ...
			          <th class="sort mb-1 text-center" data-sort="grcdNm">공통코드명</th>
			          <th class="sort mb-1 text-center" data-sort="category">코드분류</th>
			          <th class="sort mb-1 text-center" data-sort="useYn">사용여부</th>
			        </tr>
			      </thead>
			      <tbody class="list">
			        ...
			        <tr>
			          ...
			          <td class="mb-1 text-center grcdNm">${data.grcdNm}</td>
